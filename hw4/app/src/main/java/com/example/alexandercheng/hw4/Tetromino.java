...
public class Tetromino extends TGrid {
    ...
    public boolean rotateCounterClockwise() {
        ...
        ////take the transpose
        ArrayList<ArrayList<TCell>> transpose = new ArrayList<ArrayList<TCell>>();
        for(int iii = 0; iii < this.columns; iii++) {
            ArrayList<TCell> nextColumn = new ArrayList<TCell>();
        ...
        //reverse each row
        ArrayList<ArrayList<TCell>> rotated = new ArrayList<ArrayList<TCell>>();
        for(int iii = 0; iii < this.columns; iii++) {
            ArrayList<TCell> nextColumn = new ArrayList<TCell>();
            for(int jjj = 0; jjj < this.rows; jjj++) {
                nextColumn.add(null);
